...
public class DeveloperController {
    ...
    @Autowired
    public DeveloperController(Taxable taxable){ // (@Qualifier("DeveloperTax") Taxable taxable)
    ...
    public void init(){
        ...
        this.developers.put(1,new SeniorDeveloper(1,"Omer",500d));
    }
    ...
    public DeveloperResponse save(@RequestBody Developer developer){
        ...
        return new DeveloperResponse(createDeveloper,HttpStatus.CREATED.value(),"created");
    }
    ...
    public DeveloperResponse getById(@PathVariable("id") int id){
        ...
        return new DeveloperResponse(foundDeveloper,HttpStatus.OK.value(), "id is successfully searched");
    }
    ...
    public DeveloperResponse update(@PathVariable("id") int id, @RequestBody Developer developer){
        ...
        return new DeveloperResponse(newDeveloper,HttpStatus.OK.value(), "successfully updated");
    }
    ...
    public DeveloperResponse delete(@PathVariable("id") int id){
        ...
        return new DeveloperResponse(removedDeveloper,HttpStatus.NO_CONTENT.value(), "successfully deleted");
    }
